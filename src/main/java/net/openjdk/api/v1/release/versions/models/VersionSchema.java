...
public class VersionSchema {
	...
	public VersionSchema(@JsonProperty("major") String major, @JsonProperty("minor") String minor,
			@JsonProperty("security") String security, @JsonProperty("build_number") String buildNumber,
	...
	public String getVersion() {
		...
		return String.format(fmt, major, minor.isEmpty() ? "" : "." + minor, security.isEmpty() ? "" : "." + security,
				buildNumber);
	}
